...
class BaseTrainer(nn.Module):
    def __init__(self, experiment_name=None, warm_start=False, verbose=False,
        ...
        :param warm_start: when set to True, tries to load last checpoint
    ...
    def save_checkpoint(self, tag=None, path=None, mkdir=True, clear_old=False, extras=None,
                        number_ckpts_to_keep=None, **kwargs):
    ...
    def fit(self, training_data, batch_size=None, shuffle=True, epochs=1, start_epoch=1, batches_per_epoch=None,
            batcher_kwargs=None, progressbar=None, clear_outputs=False, device='auto', validate=None, val_data=None, eval_kwargs=None,
...
class SupervisedTrainer(BaseTrainer):
    def __init__(self, model: nn.Module, loss_function, opt=None, **kwargs):
        ...
        super().__init__(model=model, loss_function=loss_function, opt=opt, **kwargs)
